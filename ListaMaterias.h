...
public:
	...
	string estadistica5_1();//6.Materia con m�s matriculados
	string estadistica5_2();//7.Grupo con m�s matriculados
	string estadisticas8_1();//12.Estudiantes inactivos(c�dula - nombre) de una materia
	string estadisticas9();//15.Estudiantes de mejor nota por grupo
	string estadisticas10();//16.Listado de estudiantes con m�xima nota entre todas las materias
