...
int menuEstadisticas() {
    ...
    texto += "16.Listado de estudiantes con m�xima nota entre todas las materias\n";
    texto += "0.Volver\n";
    texto += "Opcion: ";
...
void procesarEstadisticas(int opcion) {
    ...
    break;
    case 10://10.Estudiantes activos(c�dula - nombre) de un grupo
    {
        string codigoMateria;
        cout << "Codigo de materia a investigar por estudiantes activos: "; cin >> codigoMateria;
        NodoMateria* materia = mat->consultar(codigoMateria);
    ...
    break;
    case 11://11.Estudiantes activos(c�dula - nombre) de toda la universidad
        cout << "Estudiantes activos de la universidad\n" << est->estadisticas78_3(true) << endl;
        break;
    /*8.Listado de estudiantes inactivos( c�dula-nombre) de un curso, grupo o de toda la universidad.*/
    case 12://12.Estudiantes inactivos(c�dula - nombre) de una materia
    {
        string codigoMateria;
        ...
        break;
    case 13://13.Estudiantes inactivos(c�dula - nombre) de un grupo
    {
        string codigoMateria;
        cout << "Codigo de materia a investigar por estudiantes inactivos: "; cin >> codigoMateria;
        NodoMateria* materia = mat->consultar(codigoMateria);
        ...
        break;
    case 14://14.Estudiantes inactivos(c�dula - nombre) de toda la universidad
    ...
    case 15://15.Estudiantes de mejor nota por grupo
        ...
        break;
    case 16://16.Listado de estudiantes con m�xima nota entre todas las materias
...
void procesarGrupo(int opcion, Materia* materia) {
    ...
    case 1:
    {
        ...
        if (materia != NULL) {
            ...
            if (!(cin >> status)) {
                std::cout << "El status ser� inactivo.";
                status = false;
            }
        ...
        if (grp != NULL) {
            ...
            if (estudianteTemp) {
                if (estudianteTemp->getEst()->getActivo()) {
                    ...
                    std::cout << "El estudiante esta desactivado y no podra ser a�adido al grupo." << endl;
                }
